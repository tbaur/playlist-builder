...
- `/remove <pattern>` — Remove tracks by artist or title (e.g., `/remove Luma`)
...
**Smart detection:** If you type "I don't like Luma", the chat will offer to remove those tracks instead of running a new query.
